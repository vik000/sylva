...
gh issue create \
  ...
  --milestone "Epic 1 — MVP: Python parsing + MCP server" \
  --body "## Description
...
gh issue create \
  ...
  --milestone "Epic 2 — Incremental Indexing" \
  --body "## Description
...
gh issue create \
  ...
  --milestone "Epic 3 — Test Coverage Integration" \
  --body "## Description
...
gh issue create \
  ...
  --milestone "Epic 4 — Richer Graph Queries + Visualisation" \
  --body "## Description
...
gh issue create \
  ...
  --milestone "Epic 5 — Additional Language Support" \
  --body "## Description
...
gh issue create \
  ...
  --milestone "Epic 6 — Semantic Layer" \
  --body "## Description
